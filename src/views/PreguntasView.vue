...
<template>
  ...
  <div class="fondo-movimiento relative min-h-dvh bg-transparent flex flex-col">
    ...
    <div class="flex flex-col items-center justify-center px-4 py-8">
      <div
        v-if="!esProfesor"
        class="w-full max-w-4xl backdrop-blur-sm bg-white/30 rounded-xl shadow-lg p-6 border border-white/30"
      >
        <div class="w-full z-10">
          <h1 class="text-3xl font-extrabold text-center mb-6 text-white drop-shadow-md">
            <span class="bg-gradient-to-r from-purple-600 to-blue-500 text-transparent bg-clip-text"
          ...
          <template v-if="loading">
            <div class="flex flex-col items-center py-12">
              <span
                class="aspect-square w-12 border-4 border-blue-300 rounded-full animate-spin border-t-blue-600"
              ></span>
          ...
          <template v-else-if="questions.length == 0">
            <div class="bg-white/40 rounded-lg p-8 text-center">
              ...
              <p class="text-center text-gray-800 font-medium">No hay preguntas disponibles.</p>
            </div>
          </template>
          <template v-else>
        ...
        <div class="mt-6 flex items-center justify-center">
          <div class="bg-white/50 px-4 py-2 rounded-full shadow-md">
            <span class="font-medium">
              Pregunta
              <span class="text-blue-700 font-bold">{{ currentQuestionIndex + 1 }}</span> de
              <span class="text-blue-700 font-bold">{{ questions.length }}</span>
            </span>
          </div>
        </div>
  ...
  <VaModal v-model="showModal" hide-default-actions overlay-opacity="0.2" size="large" class="z-50">
    ...
    <div class="max-h-96 overflow-y-auto p-4">
      <h3 class="text-xl font-semibold mb-4 border-b pb-2">Resultados</h3>
          ...
          <div class="flex-grow">
            ...
            <div class="mt-2 text-sm">
              <p class="flex items-center">
                <span class="font-semibold mr-2">Tu respuesta:</span>
              ...
              <p v-if="!item.isCorrect" class="flex items-center mt-1">
                <span class="font-semibold mr-2">Respuesta correcta:</span>
